      ...
      const handleUploadProduct = async(e)=>{
        ...
        // console.log("upload image",uploadImageCloudinary.url);
           ...
           const handleSubmit=async(e)=>{
            ...
            const response = await fetch(SummartApi.updateProduct.url,{
              method:SummartApi.updateProduct.method,
              credentials:'include',
              headers:{
        ...
        <div className='bg-white p-4 rounded w-full max-w-2xl h-full max-h-[80%] overflow-hidden'>
          ...
          <form className='grid p-4 gap-2 overflow-y-scroll h-full pb-5' onSubmit={handleSubmit}>
               ...
               <textarea className='bg-slate-100 h-28 border resize-none'
                ...
                <button className='px-3 py-2 mb-10 bg-red-600 text-white hover:bg-red-700 p-1 '>Update Product</button>
          </form>
