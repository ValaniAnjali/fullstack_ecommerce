       ...
       <button className='bg-white shadow-md rounded-full p-1 absolute right-0 text-lg hidden md:block' onClick={scrollRight}><FaAngleRight /></button>
       {
            ...
            loading?(
                loadingList.map((product,index)=>{
                    return(
                        <div key={index} className='w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[280px] h-36 bg-white rounded-sm shadow flex'>
                        ...
                        <div className='p-4 grid w-full gap-2'>
                            ...
                            <button className=' text-white text-sm px-3 py-0.5 rounded-full w-full bg-slate-200 animate-pulse '></button>
                        </div>
            ...
            data.map((product,index)=>{
                return(
                    <Link to={"product/"+product?._id} key={index} className='w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[280px] h-36 bg-white rounded-sm shadow flex'>
