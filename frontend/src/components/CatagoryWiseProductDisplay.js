...

       {
                ...
                loading?(   
                    loadingList.map((product,index)=>{
                        return(
                            <div className='w-full min-w-[280px] md:min-w-[320px] max-w-[280px]  md:max-w-[280px]  bg-white rounded-sm shadow '>
                            ...
                            <div className='p-4 grid gap-3'>
                                ...
                                <buttn className='text-white text-sm px-3 py-0.5  animate-pulse rounded-full bg-slate-200'></buttn>
                            </div>
                    ...
                    data.map((product,index)=>{
                        return(
                            <Link to={"/product/"+product?._id} className='w-full min-w-[280px] md:min-w-[320px] max-w-[280px]  md:max-w-[280px]  bg-white rounded-sm shadow ' onClick={()=>scrollTop}>
